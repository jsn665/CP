...
/*
You want to solve for x for the following condition : (M * x) - K >= L
...
N is the total number of available different coins and in that case the friends will be giving repeated coins.
*/
